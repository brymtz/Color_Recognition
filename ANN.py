...
#YTrain = reemplazarEtiquetas(YTrain)
...
#print("Filas: ",f)
#print("Columnas: ",lo)
#YTest = reemplazarEtiquetas(YTest)


clf = MLPClassifier(hidden_layer_sizes=(10, 10, 10, 10, 10, 10, 10), activation='relu',
...
# Calcular la precisión de la red neuronal con los datos de prueba
print(YTest)
datos = clf.predict(XTest)
